...
CREATE TABLE `PRESCRIPCION` (
  ...
  `TRATAMIENTO_ID` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `FK_PRESCRIPCION_TRATAMIENTO_ID` (`TRATAMIENTO_ID`),
  ...
  CONSTRAINT `FK_PRESCRIPCION_TRATAMIENTO_ID` FOREIGN KEY (`TRATAMIENTO_ID`) REFERENCES `TRATAMIENTO` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `RECETA` (
  ...
  `VERSION` bigint(20) DEFAULT NULL,
  `FARMACIA_ID` bigint(20) DEFAULT NULL,
  `PRESCRIPCION_ID` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `FK_RECETA_FARMACIA_ID` (`FARMACIA_ID`),
  ...
  CONSTRAINT `FK_RECETA_FARMACIA_ID` FOREIGN KEY (`FARMACIA_ID`) REFERENCES `FARMACIA` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `TRATAMIENTO` (
  ...
  `PACIENTE_ID` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `FK_TRATAMIENTO_PACIENTE_ID` (`PACIENTE_ID`),
  KEY `FK_TRATAMIENTO_MEDICO_ID` (`MEDICO_ID`),
  CONSTRAINT `FK_TRATAMIENTO_MEDICO_ID` FOREIGN KEY (`MEDICO_ID`) REFERENCES `MEDICO` (`ID`),
  CONSTRAINT `FK_TRATAMIENTO_PACIENTE_ID` FOREIGN KEY (`PACIENTE_ID`) REFERENCES `PACIENTE` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
